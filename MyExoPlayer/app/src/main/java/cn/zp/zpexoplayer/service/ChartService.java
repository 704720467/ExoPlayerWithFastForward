package cn.zp.zpexoplayer.service;
...
public class ChartService {
    ...
    public GraphicalView getGraphicalView() {
        mGraphicalView = ChartFactory.getBarChartView(context, multipleSeriesDataset, multipleSeriesRenderer, BarChart.Type.STACKED);
