...
public class PlaybackControlView extends FrameLayout {
     ...
     * 控制条回调监听
     */
    public interface VideoControlLinstion {
        /**
         * 进度更新回调
         *
         * @param duration        总进度
         ...
         * @return
         */
        boolean updateProgressBack(long duration, long currentPosition);
    ...
    private final View fullScreenButton;//全屏
    ...
    private VideoControlLinstion mVideoControlLinstion;
    ...
    public PlaybackControlView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        fullScreenButton = findViewById(R.id.exo_full_screen);
     ...
     * 更新进度回调
     *
     * @param mVideoControlLinstion
     */
    public void setVideoControlLinstion(VideoControlLinstion mVideoControlLinstion) {
        this.mVideoControlLinstion = mVideoControlLinstion;
    }
    ...
    private void hideAfterTimeout() {
        ...
        if (showTimeoutMs > 0) {
            ...
            if (isAttachedToWindow) {
                removeCallbacks(hideAction);
                postDelayed(hideAction, hideAtMs);
            }
        } else {
            hideAtMs = C.TIME_UNSET;
        }
    ...
    private void fullScreen() {
        ...
        // 更新外面控制栏的进度
        if (mVideoControlLinstion != null)
            mVideoControlLinstion.fullScreen();
    }
