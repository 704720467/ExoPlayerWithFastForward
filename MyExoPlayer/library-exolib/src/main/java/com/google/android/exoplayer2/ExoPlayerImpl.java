...
/* package */ final class ExoPlayerImpl implements ExoPlayer {
    ...
    public long getDurationUs() {
        ...
        return timeline.getWindow(getCurrentWindowIndex(), window).getDurationUs();
    }
    ...
    public long getCurrentPositionUs() {
        if (timeline.isEmpty() || pendingSeekAcks > 0) {
            ...
            timeline.getPeriod(playbackInfo.periodIndex, period);
            return period.getPositionInWindowUs() + playbackInfo.positionUs;
        }
    }
    ...
    public int getBufferedPercentage() {
        ...
        return (bufferedPosition == C.TIME_UNSET || duration == C.TIME_UNSET) ? 0 : (int) (duration == 0 ? 100 : (bufferedPosition * 100) / duration);
    }
